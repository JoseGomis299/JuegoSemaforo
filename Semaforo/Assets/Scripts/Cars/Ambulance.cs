...
public class Ambulance : Car
{
   ...
   {
      RaycastHit2D hit = Physics2D.Raycast(transform.position, Vector3.right, maxDistanceCheck, carLayer);
   ...
   protected override void OnDrawGizmosSelected()
   {
      ...
      Gizmos.DrawLine(transform.position, transform.position+Vector3.right*maxDistanceCheck);
   } 
}
